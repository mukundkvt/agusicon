...
function getSmtpSettings(): array
{
    return [
        ...
        'port'               => 587,
        'username'           => 'ae1b45001@smtp-brevo.com',
        'password'           => 'DqKY7Lsg4rUzQpWx',
        'from_email'         => 'info@agusicon.com',
        'from_name'          => 'AGUSICON 2026',
        'notification_email' => 'agusicon2025@gmail.com',
        'notification_name'  => 'AGUSICON 2026 Registrations',
        'ack_name'           => 'AGUSICON 2026 Secretariat',
...
function generateRegistrationId(string $sequencePath): string
{
    ...
    return 'AGS-Bha2026-' . str_pad((string)$serialNumber, 5, '0', STR_PAD_LEFT);
}
...
function renderEmailTable(array $rows): string
{
    ...
    foreach ($rows as $label => $value) {
        ...
        $html .= '<tr>'
            . '<td style="width:34%;padding:10px 12px;border-bottom:1px solid #e5e7eb;background:#f8fafc;font-weight:700;color:#115B86;vertical-align:top;">' . $safeLabel . '</td>'
...
$eventLocation = trim((string)($_POST['event_location'] ?? 'Blessing Garden, Bypass Road, Ramraipur, Bhadohi - 221401, Uttar Pradesh'));
...
if ($submissionStage === 'registration') {
    ...
    $registrationSequencePath = __DIR__ . '/registration-sequence-agusicon2026.txt';
    try {
    ...
    $csvPath = __DIR__ . '/registrationleads.csv';
    $combinedCsvPath = __DIR__ . '/registrations-combined.csv';
    ...
    try {
        ...
        $mail->Body = "
            <div style='font-family:Arial,Helvetica,sans-serif;color:#111827;line-height:1.6;'>
                <h2 style='margin:0 0 14px;color:#115B86;'>Step 1 of 2: Registration Details Received</h2>
                ...
                <h3 style='margin:18px 0 8px;color:#115B86;'>Submission Status</h3>
                " . renderEmailTable([
                ...
                <h3 style='margin:18px 0 8px;color:#115B86;'>Event Details</h3>
                " . renderEmailTable([
                ...
                <h3 style='margin:18px 0 8px;color:#115B86;'>Delegate Details</h3>
                " . renderEmailTable([
                    'Full Name' => $fullName,
                    'Email Address' => $email,
        ...
        $mail->Body = "
            ...
            <p>Regards,<br>AGUSICON 2026 Secretariat</p>
        ";
...
$validCategories = ['early_bird', 'till_march', 'april_june', 'spot'];
if (!in_array($paymentCategory, $validCategories, true)) {
    sendJsonResponse(400, [
        'status' => 'error',
...
$feeMap = ['early_bird' => 1100, 'till_march' => 2000, 'april_june' => 2500, 'spot' => 3000];
$labelMap = ['early_bird' => 'Early Bird', 'till_march' => 'Till 31 March 2026', 'april_june' => 'April-June 2026', 'spot' => 'Spot Registration'];
$baseAmount = $feeMap[$paymentCategory] ?? 2500;
$spouseAmount = 0;
...
$paymentCategoryLabel = $labelMap[$paymentCategory] ?? $paymentCategory;
$spouseIncludedLabel = 'N/A';
...
$paymentCsvPath = __DIR__ . '/registration-payments.csv';
$combinedCsvPath = __DIR__ . '/registrations-combined.csv';
...
try {
    ...
    $mail->Body = "
        <div style='font-family:Arial,Helvetica,sans-serif;color:#111827;line-height:1.6;'>
            <h2 style='margin:0 0 14px;color:#115B86;'>Step 2 of 2: Payment Details Received</h2>
            ...
            <h3 style='margin:18px 0 8px;color:#115B86;'>Payment Details</h3>
            " . renderEmailTable([
